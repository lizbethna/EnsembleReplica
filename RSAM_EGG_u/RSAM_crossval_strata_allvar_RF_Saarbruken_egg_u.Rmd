...
## archivo = "RSAM_crossval_strata_allvar_RF_Saarbruken_egg_a" 
```
...
## name of the files to save results
## archivo = "RSAM_crossval_strata_allvar_RF_Saarbruken_egg_i" 
```
...
## name of the files to save results
archivo = "RSAM_crossval_strata_allvar_RF_Saarbruken_egg_u" 
```
...
train1 <- train1 %>% select(-c(SEX,rep,ID_fact,STATUS_fact))
train2 <- train2 %>% select(-c(SEX,rep,ID_fact,STATUS_fact))
train3 <- train3 %>% select(-c(SEX,rep,ID_fact,STATUS_fact))
...
## Predictions
pred3.vgam <- mod3$votes
for(i in 1:n){ if(is.na(pred3.vgam[i,])){
  pred3.vgam[i,] =1/3
} }
...
pred1.new.vgam <- mod1$test$votes 
pred2.new.vgam <- mod2$test$votes 
pred3.new.vgam <- mod3$test$votes 
