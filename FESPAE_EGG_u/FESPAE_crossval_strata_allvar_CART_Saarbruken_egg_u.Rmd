...
## archivo = "FESPAE_crossval_strata_allvar_CART_Saarbruken_egg_a" 
```
...
## name of the files to save results
## archivo = "FESPAE_crossval_strata_allvar_CART_Saarbruken_egg_i" 
```
...
## name of the files to save results
archivo = "FESPAE_crossval_strata_allvar_CART_Saarbruken_egg_u" 
```
...
## Predictions
predict1.vgam <- predict(mod1, newdata = train1_par)
predict1.new.vgam <- predict(mod1, newdata = test1_par)
...
## Algo5: Compute the C response probabilities {\pi^(m,j)_{ic}}, for i=1,...,n.  
## Predictions
predict2.vgam <- predict(mod2, newdata = train2_par)
predict2.new.vgam <- predict(mod2, newdata = test2_par)
...
## Algo5: Compute the C response probabilities {\pi^(m,j)_{ic}}, for i=1,...,n.  
## Predictions
predict3.vgam <- predict(mod3, newdata = train3_par)
predict3.new.vgam <- predict(mod3, newdata = test3_par)
