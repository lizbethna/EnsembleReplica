...
archivo = "RSAM_crossval_strata_allvar_SVM_radial_Saarbruken_egg_a" 
```
...
## name of the files to save results
## archivo = "RSAM_crossval_strata_allvar_SVM_radial_Saarbruken_egg_i" 
```
...
## name of the files to save results
## archivo = "RSAM_crossval_strata_allvar_SVM_radial_Saarbruken_egg_u" 
```
