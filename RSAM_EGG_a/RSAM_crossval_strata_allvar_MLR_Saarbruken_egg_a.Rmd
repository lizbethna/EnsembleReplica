...
archivo = "RSAM_crossval_strata_allvar_MLR_Saarbruken_egg_a" 
```
...
## name of the files to save results
## archivo = "RSAM_crossval_strata_allvar_MLR_Saarbruken_egg_i" 
```
...
## name of the files to save results
## archivo = "RSAM_crossval_strata_allvar_MLR_Saarbruken_egg_u" 
```
...
mod1 <- vglm( STATUS_fact ~ . ,
              ...
              data = train1)
## Predictions
pred1.vgam <- predict(mod1, newdata = train1, "response")
...
mod2 <- vglm( STATUS_fact ~ . , 
              ...
              data = train2)
### Predictions
pred2.vgam <- predict(mod2, newdata = train2, "response")
...
mod3 <- vglm( STATUS_fact ~ . , 
              ...
              data = train3) 
### Predictions
pred3.vgam <- predict(mod3, newdata = train3, "response")
...
pred1.new.vgam <- predict(mod1, newdata = test1, "response")
pred2.new.vgam <- predict(mod2, newdata = test2, "response")
pred3.new.vgam <- predict(mod3, newdata = test3, "response")
